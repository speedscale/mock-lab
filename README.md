...
Recorded requests and responses provide runtime context for coding agents and test cases for replay. See [traffic recordings as context for coding agents](AI-CONTEXT.md).
