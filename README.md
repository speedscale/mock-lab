...
Captured traffic gives coding agents concrete behavior to inspect and replay. See [why traffic helps an AI coding agent](AI-CONTEXT.md) for a short explanation and diagram.
